...
<td align="left" width="75%" valign="top">
    ...
    <div class="middle_con" align="left">
        ...
        <div align="left" class="heading_text">Edit Offer</div>
        ...
        <form name="updateuser" method="post" action="">
            ...
            <table border="0" cellpadding="5" cellspacing="1" width="50%" align="left" class="account_con">
                ...
                <tr>
                    ...
                    <td align="right" nowrap="nowrap" class="left_fields">Review Message:</td>
                    <td align="left" nowrap="nowrap" ><textarea name="review" cols="40" rows="4" ><?php echo $reviews->review; ?></textarea
                    </td>
