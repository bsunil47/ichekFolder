<div class="content">
    <div class="module">
        ...
        <div class="module-body">
            <form name="updatereport" method="post" action="" class="form-horizontal row-fluid">
                <div class="control-group">
                    <label class="control-label" for="basicinput">Review Message:</label>
                    <div class="controls"><textarea name="review" cols="40" rows="4" class="span8"><?php echo $reports->review; ?></textarea></div>
                </div>
                <div class="control-group">
