<div class="content">
    <div class="module">
        <div class="module-head">
            <h3>Add Terms of use for Customers</h3></div>
        <div class="module-body">
            <form id="addfaq" name="addtoucust" class="form-horizontal row-fluid" action="<?php echo base_url() . 'Admin/general/toucustadd'; ?>" method="post">
