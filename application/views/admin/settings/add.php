<div class="content">
    <div class="module">
        <div class="module-head"><h3>Add Settings</h3></div>
        <div class="module-body">
            <form id="addsettings" class="form-horizontal row-fluid" action="<?php echo base_url() . 'Admin/settings/add'; ?>" method="post">
                ...
                <div class="control-group">
                    <label class="control-label" for="basicinput">Min Cashout:</label>
                    <div class="controls">
                ...
                <div class="control-group">
                    <label class="control-label" for="basicinput">Max Cashout:</label>
                    <div class="controls">
                ...
                <div class="control-group">
                    <label class="control-label" for="basicinput">Max Cashout Fee:</label>
                    <div class="controls">
                        <?php echo form_input('max_cash_out_fee', $this->input->post('max_cash_out_fee'), 'id="max_cash_out_fee", class="span8" placeholder="Enter Maximum Cashout Fee" autocomplete="off"'); ?>
                        <?php echo form_error('max_cash_out_fee'); ?>
                    </div>
                </div>
