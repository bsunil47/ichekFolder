<div class="content">
    <div class="module">
        ...
        <div class="module-body">
            <form id ="editsettings" name="editsettings" method="post" action="" class="form-horizontal row-fluid">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="max_cash_out_fee" value="<?php echo $settings->max_cash_out_fee; ?>" class="span8" />
                    </div>
                </div>
