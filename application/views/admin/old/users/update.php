        ...
        <div class="module-body">
            <form name="updateuser" method="post" action="" class="form-horizontal row-fluid">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="lastname" value="<?php echo $users->lastname; ?>" class="right_fields" /></td>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="email" value="<?php echo $users->email; ?>" class="right_fields" /></td>
                ...
                <div class="control-group">
                    <div class="controls">
                        <input type="submit" name="submit" value="Edit" class="btn" /></td>
                    </div>
                </div>
            </form>
        </div>
